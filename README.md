...
html { scroll-behavior: smooth; color-scheme: only light; background-color: #F5F0EA; }
...
.ornament-line { width: 50px; height: 1px; background: linear-gradient(90deg, transparent, #C47A45); }
.ornament-line.r { background: linear-gradient(90deg, #C47A45, transparent); }
.ornament-dot { width: 5px; height: 5px; background: #C47A45; transform: rotate(45deg); }

.cover h1 { font-family: ‘Cormorant Garamond’, serif; font-weight: 300; font-size: clamp(56px, 11vw, 100px); line-height: 0.9; color: #2E2A24; letter-spacing: -1px; }
...
.cover-scroll { position: absolute; bottom: 36px; left: 0; right: 0; display: flex; flex-direction: column; align-items: center; gap: 10px; animation: fadeUp 1.4s 0.4s ease both; }
...
.section-label { font-size: 9px; letter-spacing: 4px; text-transform: uppercase; color: #6B6840 !important; margin-bottom: 44px; display: flex; align-items: center; gap: 16px; }
...
.como-item::before { content: attr(data-num); position: absolute; top: 16px; right: 20px; font-family: ‘Cormorant Garamond’, serif; font-size: 52px; font-weight: 300; color: #A8B5A2; opacity: 0.5; line-height: 1; }
...
.servico-grupo-title { font-family: ‘Cormorant Garamond’, serif; font-style: italic; font-size: 20px; color: #6B6840 !important; margin-bottom: 24px; padding-bottom: 14px; border-bottom: 1px solid #A8B5A2; }
...
.parceria-nome { font-family: ‘Cormorant Garamond’, serif; font-size: 14px; font-weight: 500; color: #C47A45 !important; display: block; margin-bottom: 4px; letter-spacing: 0.3px; }
...
.footer-logo { font-family: ‘Cormorant Garamond’, serif; font-weight: 300; font-size: clamp(28px, 8vw, 38px); color: #1E1A14; letter-spacing: 2px; margin-bottom: 6px; text-align: center; }
...
<section class="reveal">
  ...
  <p class="sobre-detail">
    Oferecemos estruturas de produção que se adaptam ao momento da sua marca. Cada diária inclui <strong style="color:#2E2A24; font-weight:400;">4 horas de captação</strong>, roteirização, direção criativa e edição.
  </p>
